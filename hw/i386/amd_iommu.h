...
struct AMDVIState {
    ...
    /* Last (addr, len, flags) passed to IOMMU_HW_QUEUE_ALLOC for cmdbuf */
    uint64_t cmdbuf_hwq_reg_addr;
    uint64_t cmdbuf_hwq_reg_len;
    uint32_t cmdbuf_hwq_reg_flags;
    ...
    uint64_t evtlog_hwq_reg_addr;
    uint64_t evtlog_hwq_reg_len;
    uint32_t evtlog_hwq_reg_flags;
    ...
    uint64_t pprlog_hwq_reg_addr;
    uint64_t pprlog_hwq_reg_len;
    uint32_t pprlog_hwq_reg_flags;
