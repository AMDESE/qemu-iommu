...
QCOW2=/root/viommu-iommufd/ubuntu-18.04-100G-viommu.qcow2
...
-device amd-viommu,host=0000:20:00.2,iommu-id=1,intremap=off,id=amd_viommu_0,iommufd=iommufd0,translate-id=0xFFFF \
